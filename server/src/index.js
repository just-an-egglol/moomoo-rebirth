        ...
        try {
            ...
            switch(t) {
                ...
                case "r": {
                    ...
                    const targetSID = data[0];
                    if (!Number.isFinite(targetSID)) {
                        break;
                    }

                    const targetPlayer = game.players.find(p => p.sid === targetSID);
                    ...
                    player.send("t", player.x, player.y);
                ...
                case "C": {
                    ...
                    const objectsToRemove = game.game_objects.filter(obj => obj.owner === player);
                    for (const obj of objectsToRemove) {
                        if (obj.active) {
                            game.object_manager.removeObj(obj);
                        }
                    }
